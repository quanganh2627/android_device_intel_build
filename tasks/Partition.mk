...
bootimage: $(PRODUCT_OUT)/partition.tbl $(PRODUCT_OUT)/root/fstab.$(TARGET_DEVICE) $(PRODUCT_OUT)/root/fstab.charger.$(TARGET_DEVICE) $(PRODUCT_OUT)/root/fstab.ramconsole.$(TARGET_DEVICE)
