...
$(FACTORY_SCRIPTS_BOOTLOADER_IMAGE): $(BUILT_TARGET_FILES_PACKAGE)
	...
	# Generate Boot Image
	$(hide) ./vendor/intel/support/boot_efi_from_target_files.py --partition RADIO $(BUILT_TARGET_FILES_PACKAGE) $(FACTORY_SCRIPTS_BOOTLOADER_IMAGE)

$(FACTORY_SCRIPTS_FASTBOOT_IMAGE): $(BUILT_TARGET_FILES_PACKAGE)
	# Create Intermediates
	mkdir -p $(intermediates)
	# Generate EFI Image
	$(hide) ./vendor/intel/support/boot_img_from_target_files.py --partition FASTBOOT $(BUILT_TARGET_FILES_PACKAGE) $(FACTORY_SCRIPTS_FASTBOOT_IMAGE)
